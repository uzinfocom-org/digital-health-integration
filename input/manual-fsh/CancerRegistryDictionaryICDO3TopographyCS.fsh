...
* #21 "og'iz bo'shlig'i tubi old qismi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "дна полости рта передн.часть"

* #22 "og'iz bo'shlig'i tubi yon qismi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "дна полости рта боков.отдел"

* #23 "og'iz bo'shlig'i tubi kuplab qismlarining qo'shma zararlanishi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "поражение неск-ких смежных отделов дна полости рта"

* #24 "og'iz bo'shlig'i tubi QA"
  * ^designation[0].language = #ru
...
* #28 "tanglayning ko'plab qismlarining qo'shma zararlanishi"
  * ^designation[0].language = #ru
...
* #49 "ohiz-halqum ko'plab qismlarining qo'shma zararlanishi"
  * ^designation[0].language = #ru
...
* #76 "oshqozonning 12 barmoq ichakka o'tadigan qismi"
  * ^designation[0].language = #ru
...
* #78 "oshqozon kichik egriligi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "желудка малая кривизна"

* #79 "oshqozon katta egriligi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "желудка большая кривизна"

* #80 "oshqozon ko'plab qismlarining qo'shma zararlanishi"
  * ^designation[0].language = #ru
...
* #85 "Mekkel divertikuli"
  * ^designation[0].language = #ru
  * ^designation[=].value = "дивертикул Меккеля"

* #86 "ingichka ichak ko'plab qismlarining qo'shma zararlanishi"
  * ^designation[0].language = #ru
...
* #96 "yo'g'on ichak ko'plab qismlarining qo'shma zararlanishi"
  * ^designation[0].language = #ru
...
* #103 "to'g'ri ichak va anusning ko'plab qismlarining zararlanishi"
  * ^designation[0].language = #ru
...
* #138 "o'pkaning yuqori bo'lagi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "легкого верхняя доля"

* #139 "o'pkaning o'rta bo'lagi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "легкого средняя доля"

* #140 "o'pkaning pastki bo'lagi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "легкого нижняя доля"

* #141 "o'pka va bronxning ko'plab qismlarining qo'shma zararlanishi"
  * ^designation[0].language = #ru
...
* #149 "yurak, ko'ks oralig'i va plevraning ko'plab qo'shma zararlanishi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "смежное множеств.пораж-е сердца, средостения и плевры"

* #150 "yuqori nafas yo'llari"
  * ^designation[0].language = #ru
  * ^designation[=].value = "верхние дыхательные пути"

* #151 "nafas tizimi ko'plab qismlarining zararlanishi"
  * ^designation[0].language = #ru
...
* #162 "qovurg'a, to'sh, o'mrov"
  * ^designation[0].language = #ru
  * ^designation[=].value = "ребро, грудина, ключица"

* #163 "chanoq, dumg'aza va dum suyaklari"
  * ^designation[0].language = #ru
  * ^designation[=].value = "тазовая кость, крестец, копчик"

* #164 "suyak, bo'g'im, bo'g'im tog'ayining ma'lum chegaradan chiqib zararlanishi"
  * ^designation[0].language = #ru
...
* #169 "retikuloendotelial tizim QA"
  * ^designation[0].language = #ru
  * ^designation[=].value = "ретикулоэндотелиальная система БДУ"

* #170 "qon ishlab chiqaruvchi tizim QA"
  * ^designation[0].language = #ru
...
* #175 "boshning sochli qismi va bo'yin terisi"
  * ^designation[0].language = #ru
...
* #212 "katta uyatli lab"
  * ^designation[0].language = #ru
  * ^designation[=].value = "большая срамная губа"

* #213 "kichik uyatli lab"
  * ^designation[0].language = #ru
...
* #215 "qin dahlizining ko'plab qismlarining qo'shma zararlanishi"
  * ^designation[0].language = #ru
...
* #218 "bachadon bo'ynining ichki qismi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "шейки матки внутренняя часть"

* #219 "bachadon bo'ynining tashqi qismi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "шейки матки наружная часть"

* #220 "bachadon bo'yniningko'plab qismlarining qo'shma zararlanishi"
  * ^designation[0].language = #ru
...
* #226 "bachadon tanasining ko'plab qismlarining qo'shma zararlanishi"
  * ^designation[0].language = #ru
...
* #231 "bachadon keng boylami"
  * ^designation[0].language = #ru
  * ^designation[=].value = "матки широкая связка"

* #232 "bachadon yumaloq boylami"
  * ^designation[0].language = #ru
...
* #245 "yorg'oqqa tushmagan moyak"
  * ^designation[0].language = #ru
  * ^designation[=].value = "яичко неопустившееся"

* #246 "yorg'oqqa tushgan moyak"
  * ^designation[0].language = #ru
...
* #251 "erkaklar jinsiy a'zolarining boshqa sohalari"
  * ^designation[0].language = #ru
  * ^designation[=].value = "др.отделы мужских половых органов"

* #252 "erkaklar ko'plab jinsiy a'zolarining zararlanishi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "поражение несколькихмужских половых органов"

* #253 "erkaklar jinsiy a'zolari QA"
  * ^designation[0].language = #ru
...
* #269 "ko'plab ayirish a'zolarining zararlanishi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "поражение нескольких мочевых органов"

* #270 "ayirish a'zolari QA"
  * ^designation[0].language = #ru
...
* #274 "ko'z tomirli pardasi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "глаза сосудистая оболочка"

* #275 "ko'z kipriksimon tanasi"
  * ^designation[0].language = #ru
...
* #278 "ko'zning ko'plab qismlarining qo'shma zararlanishi"
  * ^designation[0].language = #ru
...
* #280 "bosh miya pardasi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "оболочка головного мозга"

* #281 "orqa miya pardasi"
  * ^designation[0].language = #ru
...
* #290 "bosh miya ustuni"
  * ^designation[0].language = #ru
  * ^designation[=].value = "ствол головного мозга"

* #291 "bosh miyaning ko'plab qismlarining qo'shma zararlanishi"
  * ^designation[0].language = #ru
...
* #299 "miya va MATning ko'plab qismlarining zararlanishi"
  * ^designation[0].language = #ru
...
* #310 "aortal glomus va boshqa paragangliylar"
  * ^designation[0].language = #ru
  * ^designation[=].value = "аортальный гломус и др.параганглии"

* #311 "endokrin bezlarining ko'plab zararlanishi"
  * ^designation[0].language = #ru
...
* #313 "bosh, yuz, bo'yin QA"
  * ^designation[0].language = #ru
  * ^designation[=].value = "голова, лицо, шея БДУ"

* #314 "ko'krak bo'shlig'i QA"
  * ^designation[0].language = #ru
...
* #324 "ko'ltiq osti va qo'llar l.t"
  * ^designation[0].language = #ru
  * ^designation[=].value = "л.у подмышки и верхней конечности"

* #325 "chov va oyoqlar l.t"
  * ^designation[0].language = #ru
...
* #327 "limfa tugunlarning ko'plab zararlanishi"
  * ^designation[0].language = #ru
