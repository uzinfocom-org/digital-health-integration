...
### Форма 066-1 - Статистическая карта выбывшего из психиатрического/наркологического стационара

На этой странице описано сопоставление полей Формы 066-1 (Статистическая карта выбывшего из психиатрического/наркологического стационара) с ресурсами FHIR.

---

### Обзор

Форма 066-1 фиксирует административные и клинические данные пациентов, выписанных из психиатрического или наркологического стационара. Данные формы сопоставляются с несколькими ресурсами FHIR, объединёнными в FHIR-документ, который соответствует профилю [Form 066-1 Psychiatric Discharge Composition](StructureDefinition-form-066-1-psychiatric-discharge-composition.html). Где это возможно, ресурсы соответствуют профилям [UZ Core](https://dhp.uz/fhir/core/en/artifacts.html).

Полный пример экземпляра см. в разделе [Пример психиатрической/наркологической выписки по Форме 066-1](Bundle-example-form-066-1-psychiatric-discharge.html).

---

### Сопоставление полей

# UZ-066-1 Статистическая карта выбывшего из психиатрического/наркологического стационара - сопоставление с FHIR

---

### Личная информация

| UZ-066-1 | RU-066-1 | Путь FHIR | Код | Пример значения |
|----------|----------|------------|------|---------------|
...
Документ Формы 066-1 структурирован как FHIR Bundle, содержащий Composition [Form066_1_PsychiatricDischargeComposition](StructureDefinition-form-066-1-psychiatric-discharge-composition.html):
...
├── Practitioner[] (лечащие врачи)
├── PractitionerRole[] (ответственные лица: врач, заведующий отделением, медсестра)
├── Condition[] (диагнозы при поступлении и заключительные)
├── Observation[] (клинические и административные измерения)
├── Coverage (тип оплаты)
├── ServiceRequest (направление в психиатрическую службу)
├── Location (место оказания помощи / палата)
└── Provenance (авторство и происхождение записи)
```

### Пример

Полный пример FHIR-документа см. в разделе [Пример психиатрической/наркологической выписки по Форме 066-1](Bundle-example-form-066-1-psychiatric-discharge.html).