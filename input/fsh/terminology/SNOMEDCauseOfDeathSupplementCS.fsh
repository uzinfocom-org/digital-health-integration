CodeSystem: SNOMEDCauseOfDeathSupplementCS
Id: snomed-cause-of-death-supplement-cs
Title: "SNOMED Cause of Death Supplement (UZ/RU)"
Description: "Uzbek and Russian designations for selected SNOMED cause of death codes"

* insert SupplementCodeSystemDraft(snomed-cause-of-death-supplement-cs, http://snomed.info/sct, 20240131)
