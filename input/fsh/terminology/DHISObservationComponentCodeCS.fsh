...
* #tub004-0005 "AMK/KAN/CAP natijasi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Результат AMK/KAN/CAP"
  * ^designation[+].language = #en
  * ^designation[=].value = "AMK/KAN/CAP result"

* #tub004-0006 "AMK/KAN natijasi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Результат AMK/KAN"
  * ^designation[+].language = #en
  * ^designation[=].value = "AMK/KAN result"

* #tub004-0007 "Rifampitsin (1,0 mg/ml)"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Рифампицин (1,0 мг/мл)"
  * ^designation[+].language = #en
...
* #tub004-0014 "Gatifloksatsin (0,25 mg/ml)"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Гатифлоксацин (0,25 мг/мл)"
  * ^designation[+].language = #en
