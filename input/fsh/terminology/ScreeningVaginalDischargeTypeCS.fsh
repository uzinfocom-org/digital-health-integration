...
Description: "CodeSystem for Screening Vaginal Discharge Type"
...
* #scrn-0019-00003 "Ko‘pikli"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Пенные"
  * ^designation[+].language = #en
  * ^designation[=].value = "Foamy"
...
* #scrn-0019-00005 "Qonli"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Кровянистые"
  * ^designation[+].language = #en
  * ^designation[=].value = "Bloody"

* #scrn-0019-00006 "Shilliq"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Слизистые"
  * ^designation[+].language = #en
  * ^designation[=].value = "Mucous"
