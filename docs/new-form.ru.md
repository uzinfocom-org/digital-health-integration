...
Руководство по созданию новой клинической формы (документа) в этом IG на примере уже готовых форм 011 (гемодиализ), 066 и 066-1 (статистические карты выписки) и 130 (результаты лабораторных исследований). Форма 130 - образец лучшей практики: при расхождениях ориентируйтесь на неё.
